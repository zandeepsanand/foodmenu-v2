...
export default function FoodItemList(props) {
  ...
  return (
    ...
    return(  <div class="col-sm-6 col-md-6 p-1" id="list-item-1">
      
        <div class="card curve shadow p-0 mb-0 bg-white rounded" onClick={handleShow}>
          <div class="card-body ">
            <div className="row" >
              <div className="col-3 ">
                <img className="card-image" src={items.pro_image} alt="pic" />
              </div>
              
              <div className="col-9 ">
                <div className="prize-label button-colors  ">{items.pro_price}
